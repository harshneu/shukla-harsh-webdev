module.exports = function () {
    ...
    var api = {
        ...
        "deleteWebsiteSubPages"  :deleteWebsiteSubPages,
        "setModel"                  :setModel
    };
    ...
    function deleteWebsite(websiteId){
        return WebsiteModel.findOne({_id:websiteId}).populate('_user').then(function (website) {
            ...
            website._user.save();
            return deleteWebsiteSubPages(websiteId);
        }, function (err) {
           return err;
        });
    }

    function continousDelete(pagesOfWebsite, websiteId) {
        ...
        return model.pageModel.deletePageSubPages(pagesOfWebsite.shift())
            .then(function (response) {
                if(response.result.n == 1 && response.result.ok == 1){
                    return continousDelete(pagesOfWebsite, websiteId);
                }
            }, function (err) {
                return err;
            });
    ...
    function deleteWebsiteSubPages(websiteId){
