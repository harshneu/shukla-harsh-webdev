module.exports = function () {
    ...
    function continousDelete(websitesOfUser, userId) {
        ...
        return model.websiteModel.deleteWebsiteSubPages(websitesOfUser.shift())
            .then(function (response) {
                if(response.result.n == 1 && response.result.ok == 1){
                    return continousDelete(websitesOfUser, userId);
                }
            }, function (err) {
                return err;
            });
