(function(){
    ...
    function WebsiteService() {
        var websites = [
            ...
            {_id: "456", name : "Tic Tac Toe", developerId: "123", description:"Tic-tac-toe is a paper-and-pencil game for two players, X and O, who take turns marking the spaces in a 3×3 grid."},
            {_id: "567", name : "Checkers", developerId: "111", description:"Checkers is a group of strategy board games for two players which involve diagonal moves of uniform game pieces and mandatory captures by jumping over opponent pieces. Draughts developed from alquerque."},
