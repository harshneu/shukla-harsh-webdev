(function(){
    'use strict';
    // URL and Api keys for our APIs from where we receive our data from
    ...
    //album service to find the albums.
    ...
    function albumService($http) {
        ...
        // searches albums on the basis of id.
        function findAlbumsByMbId(mbId) {
            var url = INFO_URL.replace("MBID", mbId);
            return $http.get(url);
        }

        // searches albums on the basis of title.
